                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <P><b>Nama Siswa:</b></p>
                      <input class="form-control" type="text" name='nama' placeholder="Nama Siswa..." value="<?php echo $d['nama']; ?>" required><br>

                      <P><b>Alamat:</b></p>
                      <input class="form-control" type="text" name='alamat' placeholder="Alamat..." value="<?php echo $d['alamat']; ?>" required><br>
