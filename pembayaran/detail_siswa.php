      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if ($ggl) {
            ...
            $det = mysqli_query($conn, "select * from anggota where id='$id_brg'") or die(mysqli_error($conn));
          ...
          ?>
                ...
                <div class="card-body">
                  ...
                  <div class="row ml-5">
                    <div class="col-md-10 col-sm-12 col-xs-12">
                      <h2>
                        <center>Info Detail Siswa</center>
                      </h2>
                      <table class="table">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <a href="data_siswa.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                </div>
