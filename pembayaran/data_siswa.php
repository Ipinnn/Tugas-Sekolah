...
<head>
  ...
  <!-- STYLE CSS -->
  <link href="css/cp-dsi.min.css" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Kas Kelas <br> XI RPL</div>
      </a>
            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8  mt-4">
                  ...
                  <h7 class="m-0 font-weight-bold">Kapasitas Siswa: <?php echo $kap; ?></h7><br>

                </div>

                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_siswa.php" method="get" name='cari'>
                    <input class="form-control mr-sm-2" type="search" placeholder="Cari Siswa" aria-label="Search" name='cari' required>
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <td>&nbsp;<a href="edit_siswa.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; 
                              <a href="hapus_siswa.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; 
                              <a href="detail_siswa.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a>
                          </td>
                        </tr>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>
              <p class="mb-1">Copyright &copy; <a style="text-decoration: none;"><b>PKL PT DSI</b></a></p>
            </span><br>
          </div>
        </div>
      </footer>
