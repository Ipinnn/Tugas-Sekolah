                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <P><b>Pengeluaran:</b></p>
                      <input class="form-control" type="text" name='nama' placeholder="Nama Barang..." value="<?php echo $d['nama']; ?>" required><br>


                      <P><b>Harga:</b></p>
                      <input class="form-control" type="number" name='jumlah' placeholder="Jumlah..." value="<?php echo $d['jumlah']; ?>" required><br>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>
              <p class="mb-1">Copyright &copy; <a href="https://github.com/Faiznurullah" style="text-decoration: none;"><b>Faiz Nurullah</b></a></p>
            </span><br>
          </div>
        </div>
      </footer>
