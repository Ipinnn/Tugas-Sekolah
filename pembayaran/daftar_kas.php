              ...
              <div class="row mt-3">
                ...
                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_kas.php" method="get" name='cari'>
                    <input class="form-control mr-sm-2" type="search" placeholder="Cari..." aria-label="Search" name='cari' required>
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <td>&nbsp;<a href="edit_kas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; 
                          <a href="hapus_kas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp;</td>
