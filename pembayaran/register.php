                            ...
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <form action="register_proses.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="cpassword" class="form-control form-control-user" id="exampleInputCPassword" placeholder="Confirm Password">
                                        </div>
                                        <button class="btn btn-primary btn-user btn-block" name="simpan">Simpan</button>
                                        <hr>
                                        <center>
                                            <div class="text-center">
                                                <div class="small">Anda Sudah Punya Akun?
