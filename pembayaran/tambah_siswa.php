            ...
            ?>
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img class="img-profile rounded-dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="profile.php">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                    Profilecircle" src="img/<?php echo $rrr['foto']; ?>" alt="profile">
                </a>
              ...
              <form action='' name='kirim' method='post'>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input class="form-control form-control-sm" type="text" placeholder="Nama Siswa.." aria-label=".form-control-sm example" name='nama' required>
                  </div>
