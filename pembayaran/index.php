...
// $Jumlah_kas = mysqli_query($conn, "select (sum(jumlah) - max(jumlah)) as kas from kas");
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "Rp." . number_format($total['kas'] - $total_out['keluar']); ?> </div>
                    </div>
                    <div class="col-auto">
