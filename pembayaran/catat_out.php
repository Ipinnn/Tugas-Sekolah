        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="col-sm-4">
              <label>Nomial:</label>
              <input class="form-control form-control-sm" type="number" placeholder="Nominal..." aria-label=".form-control-sm example" name='jumlah' required>
              </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span><p class="mb-1">Copyright &copy; <a style="text-decoration: none;"><b>PKL PT DSI</b></a></p></span><br>
          </div>
        </div>
      </footer>
